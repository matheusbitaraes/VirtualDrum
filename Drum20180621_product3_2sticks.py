...
while True:
    ...
    mask_2a = cv2.morphologyEx(mask_2a, cv2.MORPH_OPEN, cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (15, 15)))
    mask_2b = cv2.morphologyEx(mask_2b, cv2.MORPH_OPEN, cv2.getStructuringElement(cv2.MORPH_ELLIPSE, (15, 15)))
