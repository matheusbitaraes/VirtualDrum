...
'''def callback(recognizer, audio):
    # received audio data, now we'll recognize
    print("show rogerin")'''
...
while True:
    ...
    '''with m as source:
        try:
            audio = r.listen(source, timeout=0.01)
            print(rms(audio))
    ...
    '''for _ in range(0, int(RATE / CHUNK * RECORD_SECONDS)):
        try:
            ...
            data = []  # or however you choose to handle it, e.g. return None
    ...
    if energy > 0.05:
        ...
        streamout.write(samples * energy/0.2)
